...
import {
  ...
  projectClientStatsResponseSchema,
  ...
  app.get(
    "/overview",
    {
      schema: {
        ...
        response: {
          200: projectsOverviewResponseSchema
        }
      }
    },
    async (request) => getProjectsOverview(getUserId(request), request.query)
  );
  ...
  app.get(
    "/:id/clients",
    {
      schema: {
        ...
        querystring: projectStatsQuerySchema,
        response: {
          200: projectClientStatsResponseSchema
        }
      }
    },
    async (request) =>
      getProjectClientStats(getUserId(request), request.params.id, request.query)
  );
